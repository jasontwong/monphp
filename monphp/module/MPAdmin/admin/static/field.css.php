...
.ui-datepicker-calendar td a:hover { background-color: #C7B16C; color: #000; }
...
.ui-corner-all { margin-top: -3px; font-size: 1.1em; }

.ui-datepicker-calendar .ui-state-active { background-color: orange; }
.ui-slider-vertical { margin-top: 8px; background-color: #CCC; }
.ui-slider-vertical .ui-slider-handle { left: -3px; background-color: #333; }
