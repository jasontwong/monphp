...
.MPFileManager_image_container .delete { position: absolute; right: 2px; top: 2px; }
.MPFileManager_image_container .image { border: 0px; float: none; height: 90px; margin: 0px auto; padding: 0px; width: 90px; }
