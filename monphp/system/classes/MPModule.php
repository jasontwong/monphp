...
class MPModule
{
    ...
    //}}}
    //{{{ static public function hook_user($hook, $target = MPModule::TARGET_ALL)
    /**
    ...
    //}}}
    //{{{ static public function active($target = MPModule::TARGET_ALL)
    /**
    ...
    //}}}
    //{{{ static public function available($target = MPModule::TARGET_ALL)
    /**
    ...
    //}}}
    //{{{ static public function install($target = MPModule::TARGET_ALL)
    static public function install($target = MPModule::TARGET_ALL)
    {
        self::load_active();
        if ($target === MPModule::TARGET_ALL)
    ...
    //}}}
    //{{{ static public function h($hook, $target = MPModule::TARGET_ALL)
    /**
