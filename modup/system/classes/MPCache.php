...
Unlike SystemMPData, the MPCache class does not wait until the end of the request to
...
class MPCache
{
    ...
    public static function get($key, $namespace=NULL)
    {
        ...
        $result = MPDB::selectCollection('cache_data')->find($query, array('data'));
        return $result 
    ...
    public static function get_multi($keys, $key_prefix='', $namespace=NULL)
    {
        ...
        $rows = MPDB::selectCollection('cache_data')->find($query);
    ...
    public static function flush_all()
    {
        try
        {
            MPDB::selectCollection('cache_data')->drop();
            return TRUE;
        }
        catch (Exception $e)
        {
