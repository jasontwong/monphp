...
<table>
    ...
    <tbody>
        <?php foreach ($files['dirs'] as $file): ?>
            <tr>
                <td><a href='/admin/module/FileManager/browse<?php echo htmlentities($file['link'], ENT_QUOTES) ?>'>dir</a></td>
                <td><a href='/admin/module/FileManager/browse<?php echo htmlentities($file['link'], ENT_QUOTES) ?>'><?php echo htmlentities($file['name']) ?></a></td>
                <td></td>
                <td></td>
            </tr>
        <?php endforeach ?>
