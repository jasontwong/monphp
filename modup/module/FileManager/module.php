...
class FileManager
{
    ...
    const MODULE_DESCRIPTION = 'FileManager Module';
    ...
    public function hook_active()
    {
        ...
        self::$file_path = !is_null(Data::query('FileManager', 'file_path'))
            ? Data::query('FileManager', 'file_path')
            : DIR_FILE.'/upload';
        self::$web_path = !is_null(Data::query('FileManager', 'web_path'))
            ? Data::query('FileManager', 'web_path')
            : '/file/upload';
    ...
    {
        $screen = array();
        if (strpos(URI_PATH, '/admin/mod/FileManager/') === 0)
        {
            $screen[] = '/admin/static/Admin/screen.css/';
            $screen[] = '/admin/static/FileManager/browse.css/';
        }
        else
        {
            $screen[] = '/admin/static/FileManager/field.css/';
        }
    ...
    public function hook_admin_js()
    {
        $js[] = '/admin/static/FileManager/jquery.windowmsg-1.0.js/';
        if (strpos(URI_PATH, '/mod/FileManager/browse/') !== FALSE)
        {
            $js[] = '/admin/static/FileManager/filemanager.js/';
        }
        else
        {
            $js[] = '/admin/static/FileManager/admin_nav.js/';
            $js[] = '/admin/static/FileManager/field.js/';
            $js[] = '/admin/static/FileManager/tinymce.js/';
        }
        return $js;
    }
    ...
    {
        $js = array();
        if (strpos(URI_PATH, '/mod/FileManager/') !== FALSE)
        {
            $js[] = '/admin/static/FileManager/jquery.js/';
            $js[] = '/admin/static/Admin/admin.js/';
        }
        if (strpos(URI_PATH, '/admin/mod/FileManager/browse/tinymce/') !== FALSE)
        {
            $js[] = '/file/module/Admin/js/tiny_mce/tiny_mce.js';
            $js[] = '/file/module/Admin/js/tiny_mce/jquery.tinymce.js';
            $js[] = '/file/module/Admin/js/tiny_mce/tiny_mce_popup.js';
            $js[] = '/admin/static/FileManager/tinymce_browse.js/';
        }
        return $js;
    }
    ...
    {
        return array(
            'file_browser_callback' => 'FileManager_browser'
        );
    }
    ...
    public function hook_routes()
    {
        ...
        $routes = array(
            array('#^/admin/mod/FileManager/rpc/([^/]+/)+$#', $ctrl.'/rpc.php', Router::ROUTE_PCRE),
        );
        return $routes;
    }
    ...
    public static function set_web_path($path)
    {
        Data::update('FileManager', 'web_path', $path);
        self::$web_path = $path;
        return self::$web_path;
    }
    //}}}
    ...
    public static function set_file_path($path)
    {
        Data::update('FileManager', 'file_path', $path);
        self::$file_path = $path;
        return self::$file_path;
    }
    //}}}
    ...
    public static function scan($dir)
    {
        if (is_dir($dir))
        {
            ...
            $link_base = str_replace(FileManager::file_path(), '', $dir);
            $files = $dirs = array();
            $scans = scandir($dir);
        ...
        elseif (is_file($dir))
        {
            throw new FileManagerIsFileException($dir.' is a file');
        }
        else
        {
            throw new FileManagerNotExistException($dir.' does not exist');
        }
    }
    //}}}
    ...
    public static function dir_scan($dir)
    {
        ...
        if (file_exists($dir) && is_dir($dir))
        {
             ...
             */
            $the_dir = str_replace(FileManager::file_path(), '', $dir);
            if (empty($the_dir))
            {
                $the_dir = '/';
            }
    ...
    public static function get_image_sizes()
    {
        ...
        $sizes['thumb'] = !is_null(Data::query('FileManager', 'size_thumb'))
            ? Data::query('FileManager', 'size_thumb')
            : $default_size;
        $sizes['medium'] = !is_null(Data::query('FileManager', 'size_medium'))
            ? Data::query('FileManager', 'size_medium')
            : $default_size;
        $sizes['large'] = !is_null(Data::query('FileManager', 'size_large'))
            ? Data::query('FileManager', 'size_large')
            : $default_size;
        return $sizes;
    }
    //}}}
...
class FileManagerNotExistException extends Exception {}
class FileManagerIsFileException extends Exception {}
