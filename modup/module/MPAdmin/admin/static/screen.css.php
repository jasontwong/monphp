...
/*}}}*/
/*{{{elements*/
body { font-size: 62.5%; font-family: Arial,sans-serif; background-color: <?php echo !is_null(MPData::query('MPAdmin', 'bgcolor')) ? MPData::query('MPAdmin', 'bgcolor') : '#FFFFFF'; ?>; }
