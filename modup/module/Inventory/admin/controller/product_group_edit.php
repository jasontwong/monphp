...
Admin::set('title', 'Edit an inventory product group');
Admin::set('header', 'Edit an inventory product group');
...
if ($_POST)
{
    ...
    $pg_id = Inventory::update_product_group(
        URI_PART_4,
        $pgroup['name'], 
