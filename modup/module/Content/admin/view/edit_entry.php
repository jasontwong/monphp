...
<?php $r_dates = Doctrine_Query::create()->select('modified')->from('ContentEntryTitle')->where('content_entry_meta_id = ?', array($entry['id']))->fetchArray(); ?>
<div id='sidebar'>
...
if ($access_level === Content::ACCESS_VIEW)
{
