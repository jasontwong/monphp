    ...
    <tbody>
        <?php if (count($entries)): ?>
            ...
            <?php foreach ($entries as $entry): ?>
                ...
                <?php
                    $title = '<a href="/admin/module/Content/edit_entry/'.$entry['id'].'/">'.$entry['title'].'</a>';
                    $type = '<a href="/admin/module/Content/edit_entries/'.$entry['ContentEntryType']['id'].'/">'.$entry['ContentEntryType']['name'].'</a>';
                    ...
                    if (Module::is_active('Taxonomy'))
                    {
                        $taxonomy = Module::h('content_get_entry_taxonomy', 'Taxonomy', $entry['ContentEntryType']['id'], $entry['id'], 'status');
